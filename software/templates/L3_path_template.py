...
for  count, motion in enumerate(motions):
    ...
    log.tmpFile(motion[0],'chassis_forward_velocity')           # log chassis forward velocity (x dot)
    log.tmpFile(motion[1],'chassis_angular_velocity')           # log chassis angular velocity (theta dot)
